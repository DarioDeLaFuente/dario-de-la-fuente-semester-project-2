    ...
    <>
      ...
      <div className="container">
        <div className="py-5 text-center">
          <h1>The Market of Opportunities.</h1>
          <p className="lead">
        ...
        <div className="row">
          ...
          <div className="col-md-8 order-md-3">
            <h2 className="mt-3">Create a Listing</h2>
            <CreateEntry onEntryCreated={handleEntryCreated} />
          </div>
          <div className="col-md-8 order-md-4 mt-3">
            <h2 className=" justify-content-between align-items-center">Your entry list:</h2>
          ...
          <div className="col-md-4 order-md-5 mt-3">
            <div>
              <h2 className="justify-content-between align-items-center ">Your entry vins:</h2>
