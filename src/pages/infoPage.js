      ...
      <Container>
        ...
        <Row>
          <Col md={{ span: 6, offset: 1 }}>
            <div className="card-info-container mb-5">
          ...
          <Col md={4}>
            <FcRightDown2 className="info-icon ip-icon-logo"></FcRightDown2>
          </Col>
        </Row>
        <Row>
          <Col md={4}>
            <FcLeftDown2 className="info-icon ip-icon-logo"></FcLeftDown2>
          </Col>
